...
class App
{
    ...
    public static function create(string $projectDir, string $sourceDir, string $cacheDir): App
    {
        ...
        $appConfiguration->cacheDirectory = realpath($cacheDir);
        $appConfiguration->sourceDirectory = realpath($sourceDir);
        $appConfiguration->projectDirectory = realpath($projectDir);
        $appConfiguration->aliases['@project'] = $appConfiguration->projectDirectory;
